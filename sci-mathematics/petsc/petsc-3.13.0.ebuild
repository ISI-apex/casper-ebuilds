...
PATCHES=(
	...
	"${FILESDIR}"/${P}-do_not_run_mpiexec.patch
	"${FILESDIR}"/${P}-lowercase-pkgname.patch
	"${FILESDIR}"/${P}-pkgconfig-split.patch
	"${FILESDIR}"/${P}-pastix-v6-via-v5-compat.patch
	"${FILESDIR}"/${P}-pastix-params.patch
	"${FILESDIR}"/${P}-pastix-comm-type.patch
	"${FILESDIR}"/${P}-pastix-refine.patch
)
