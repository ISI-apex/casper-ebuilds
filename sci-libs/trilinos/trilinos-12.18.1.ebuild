...
inherit cmake toolchain-funcs multilib toolchain-funcs
...
#)
PATCHES=(
	"${FILESDIR}"/${P}-fix_install_paths.patch
...
src_configure() {
	local mycmakeargs=(
		...
		-DTPL_ENABLE_Cholmod="$(usex sparse)"
	...
	#
	# cmake eclass patches the base directory CMakeLists.txt
...
# superlu broken
#staging/jnw2/acolin/casper/glprefix/var/tmp/portage/sci-libs/trilinos-12.18.1/work/Trilinos-trilinos-release-12-18-1/packages/shylu/shylu_dd/bddc/src/shylu_SuperLU.cp
#p:52:1: error: conflicting declaration of C function 'void dgssvx(superlu_options_t*, SuperMatrix*, int*, int*, int*, char*, double*, double*, SuperMatrix*, SuperMatri
#x*, void*, int, SuperMatrix*, SuperMatrix*, double*, double*, double*, double*, mem_usage_t*, SuperLUStat_t*, int*)'
#   52 | dgssvx(superlu_options_t *, SuperMatrix *, int *, int *, int *,
#         | ^~~~~~
#	 In file included from /staging/jnw2/acolin/casper/glprefix/var/tmp/portage/sci-libs/trilinos-12.18.1/work/Trilinos-trilinos-release-12-18-1/packages/shylu/shylu_dd/bdd
#	 c/src/shylu_SuperLU.hpp:52,
#	                  from /staging/jnw2/acolin/casper/glprefix/var/tmp/portage/sci-libs/trilinos-12.18.1/work/Trilinos-trilinos-release-12-18-1/packages/shylu/shylu_dd/bdd
#			  c/src/shylu_SuperLU.cpp:48:
#			  /staging/jnw2/acolin/casper/glprefix/usr/include/superlu/slu_ddefs.h:111:1: note: previous declaration 'void dgssvx(superlu_options_t*, SuperMatrix*, int*, int*, int*,
#			   char*, double*, double*, SuperMatrix*, SuperMatrix*, void*, int, SuperMatrix*, SuperMatrix*, double*, double*, double*, double*, GlobalLU_t*, mem_usage_t*, SuperLUSta
#			   t_t*, int*)'
#			     111 | dgssvx(superlu_options_t *, SuperMatrix *, int *, int *, int *,
#			           | ^~~~~~
#				   make[2]: *** [packages/shylu/shylu_dd/bddc/src/CMakeFiles/shylu_ddbddc.dir/build.make:93: packages/shylu/shylu_dd/bddc/src/CMakeFiles/shylu_ddbddc.dir/shylu_SuperLU.cpp.o] Error 1
